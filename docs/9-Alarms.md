...
> **Navigation:** [← I/O Binding](8-IO-Binding.md) · [README](../README.md) · [Architecture](7-Architecture.md)

---

## 9.1 Alarms vs. Faults
...
## 9.3 Common Status: `ST_Alarm_Sts`
...
## 9.4 Common Config: `ST_Alarm_Cfg`
...
## 9.6 `FB_AlarmBase` — The Shared Engine
...
## 9.9 Wiring Alarms to Devices

Two common patterns:

### 9.9.1 Device composes alarms internally
...
### 9.9.2 Standalone alarm in `GVL_HW` or a program
...
## 9.11 Checklist for a New Alarm FB
...
5. Update `cfg`'s OPC UA pragmas following §4 so the HMI can drive it.
6. Add an entry to [§9.7](#97-concrete-alarms) so the docs list stays accurate.
